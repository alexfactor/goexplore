...
<body <?php body_class(); ?>>
	<div id="page" class="site">
			...
			<section class="search">
				<div class="container">
					...
					<?php if( class_exists( 'WooCommerce' ) ): ?>
								<div class="account col-md-6 col-12">
			...
			<section class="top-bar">
				<div class="container">
					<div class="row">
								<div class="col-12 col-md-4 mt-auto">
									<nav class="main-menu navbar navbar-expand-md navbar-light" role="navigation">
										...
										<button class="navbar-toggler ml-auto" type="button" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-controls="bs-example-navbar-collapse-1" aria-expanded="false" aria-label="Toggle navigation">
											...
											<?php
											wp_nav_menu( array(
												'theme_location'    => 'go_explore_main_menu',
												'depth'             => 3,
												'container'         => 'div',
						...
						<div class="col-12 col-md-4 mt-auto">
						<nav class="main-menu navbar navbar-expand-md navbar-light navbar-right" role="navigation">
										<!-- Brand and toggle get grouped for better mobile display -->
											<?php
											wp_nav_menu( array(
												'theme_location'    => 'go_explore_main_menu_right',
												'depth'             => 3,
												'container'         => 'div',
												'container_class'   => 'collapse navbar-collapse',
												'container_id'      => 'bs-example-navbar-collapse-1',
		...
		<?php get_template_part('template-parts/nav/activity');